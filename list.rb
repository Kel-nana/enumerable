...
class MyList
  include MyEnumerable # This allows the MyList class to use the methods defined in the 'Enumerable' module.
...
puts(list.filter(&:odd?)) # Output: [1, 3, 1]
...
puts list.max(3) # Output: [1, 1, 2]
puts list.min(2) # Output: [1, 1,]
