...
**Enumerable** is a simple ruby code to work with list and methods on lists.
...
```sh
  git git@github.com:Kel-nana/enumerable.git
  cd enumerable
```
...
Feel free to check the [issues page](https://github.com/Kel-nana/enumerable/issues).
